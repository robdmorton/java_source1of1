...
public class HelloServiceServiceLocator extends org.apache.axis.client.Service implements exampleservice.HelloServiceService {
    ...
    private java.lang.String HelloService_address = "http://localhost:8080/BottomUpWebServiceHello/services/HelloService";
    ...
    public exampleservice.HelloService getHelloService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            exampleservice.HelloServiceSoapBindingStub _stub = new exampleservice.HelloServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (exampleservice.HelloService.class.isAssignableFrom(serviceEndpointInterface)) {
                exampleservice.HelloServiceSoapBindingStub _stub = new exampleservice.HelloServiceSoapBindingStub(new java.net.URL(HelloService_address), this);
                _stub.setPortName(getHelloServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://exampleservice", "HelloServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://exampleservice", "HelloService"));
        }
