...
<jsp:useBean id="sampleHelloServiceProxyid" scope="session" class="exampleservice.HelloServiceProxy" />
<%
...
case 10:
        gotMethod = true;
        exampleservice.HelloService getHelloService10mtemp = sampleHelloServiceProxyid.getHelloService();
...
case 13:
        ...
        java.lang.String echo13mtemp = sampleHelloServiceProxyid.echo(msg_1idTemp);
if(echo13mtemp == null){
%>
<%=echo13mtemp %>
<%
