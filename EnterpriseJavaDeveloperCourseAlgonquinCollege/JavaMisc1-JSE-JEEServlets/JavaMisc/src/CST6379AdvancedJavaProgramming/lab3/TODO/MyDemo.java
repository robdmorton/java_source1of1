package CST6379AdvancedJavaProgramming.lab3.TODO;
 ...
 * @author Ian
 * 
 * TODO 00. Create a simple GUI with a menu bar, status bar and toolbar. 
 * Add a JTable to the contentPane and register action listeners for the buttons.
 * 
...
public class MyDemo {
    ...
    private void createTable() {
        String[] columnNames = { "First Name", "Last Name", "Favourite Course",
                "# of Years", "Likes Sushi" };

        Object[][] data = {
                { "John", "Doe", "Advanced Java Programming", new Integer(5),
                        new Boolean(false) },
                { "Alison", "Huml", "Advanced Java Programming",
                        new Integer(3), new Boolean(true) },
                { "Kathy", "Walrath", "Advanced Java Programming",
                        new Integer(2), new Boolean(false) },
                { "Sharon", "Zakhour", "Advanced Java Programming",
                        new Integer(20), new Boolean(true) },
                { "Philip", "Milne", "Advanced Java Programming",
