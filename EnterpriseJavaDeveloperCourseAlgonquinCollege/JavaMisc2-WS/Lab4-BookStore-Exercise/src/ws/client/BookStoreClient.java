...
public class BookStoreClient {
    ...
    // TODO 01. Review this method for an introduction to Java SOAP programming.
    public void submitRequest() {
        ...
        try {
            ...
            Name titleName = soapFactory.createName("title");
            SOAPBodyElement request = body.addBodyElement(search);
            SOAPElement element = request.addChildElement(titleName);

            Name echoName = soapFactory.createName("echo");
            SOAPElement echo = request.addChildElement(echoName);
