...
public class BookStoreServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        // TODO 02. Check for the "xml" request parameter.
//        boolean foundXmlRequestParameter = false;
    ...
    /**
     * This method handles SOAP messages from a standalone Java client.
     * 
     * @param request
     * @param response
     * @throws IOException
    ...
    private void handleClientRequest(HttpServletRequest request,
        ...
        try {
            ...
            // TODO 03. Get the InputStream from the request.
            InputStream input = request.getInputStream();
            BookSearchResult book = bookSearch.searchAuthorByTitle(input);;
            // TODO 04. Assign the return value to the book variable.
//            bookSearch.searchAuthorByTitle(input);
    ...
    /**
     * This method handles SOAP messages from a JSP page.
     * 
     * @param request
     * @param response
     * @throws IOException
    ...
    private void handleFormSubmit(HttpServletRequest request,
        ...
        BookSearchResult book = bookSearch.searchAuthorByTitle(xml);;
        // TODO 11. Assign the return value to the book variable.
//        bookSearch.searchAuthorByTitle(xml);
        response.setContentType(XML_CONTENT_TYPE);
        PrintWriter out = response.getWriter();
        sendBookInformation(out, book);
    }
