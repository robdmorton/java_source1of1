 ...
 * 
 * <p>
 * In this project a new class called
 * <code>ws.business.PurchaseSummaryService</code> has been started for you.
 * </p>
 * 
 * <p>
 * This class is modeled after the <code>ws.business.ExampleService</code>
 * class.
 * </p>
 * 
 * <p>
 * The new class should assume it is receiving a document that is structured
 * like the purchases.xml file that was downloaded in Part 2.
 * </p>
 * 
 * <p>
 ...
 * 
 * <ol>
 * <li>the total number of purchases</li>
 * <li>the sum of all purchases in the input document</li>
 * </ol>
 * <p>
 * The <code>PurchaseSummaryService</code> must then produce an output XML
 ...
 * </pre>
 * 
 * See the Task list for the next step.
 * 
 * 
 */
public class PurchaseSummaryService extends DefaultHandler implements
	...
	public void endElement(String namespaceURI, String sName, // simple name
		...
		if (qName.equals("purchase")) {
			...
			// TODO 06. perform running total of the purchaseTotal variable.
			String value = elementCharacters.toString();
			float amountToAdd = Float.parseFloat(value);
			purchaseTotal=purchaseTotal+amountToAdd;
		}
	}
