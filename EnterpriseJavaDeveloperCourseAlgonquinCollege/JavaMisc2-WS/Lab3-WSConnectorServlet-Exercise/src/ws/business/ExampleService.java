 ...
 * @author jlarstone
 * 
 * This service counts the number of elements in any XML document using a SAX
 * parser.
 */
public class ExampleService extends DefaultHandler implements
        WSServiceInterface {
    ...
    /*
     * WSServiceInterfac e implementation. Parse the input document and return a
     * result document.
     */
    ...
    /*
     * When a start element occurs all we want to do is remove the character
     * data associated with the previous element.
     */
    ...
    /*
     * When an end element occurs update the element count. This is also the
     * time to use any character data collected for an element.
     */
    ...
    /*
     * Called for each chunk of character data associated with an element.
     */
    ...
    public String process(String salesURL, InputStream inputStream) {
