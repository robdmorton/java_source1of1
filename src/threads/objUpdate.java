...
/*
 * objUpdate.java uses a collection to store objects -- March 18 2006 and shows how to read and
 * write file objects using serialization Concepts such as swing, events, exceptions and ArrayList
 * are used.
 */
...
public class objUpdate extends JFrame {
  ...
  class NewPerson implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      String name = null;
      name = JOptionPane.showInputDialog(objUpdate.this, "Enter a name (eg. John Russell)",
          "Input Person", JOptionPane.QUESTION_MESSAGE);
      if (!(name == null)) {
        // prompt the user for a date
        String date = null;
        date = JOptionPane.showInputDialog(objUpdate.this, "Enter Date (eg. 06/17/1946)",
            "Input Person", JOptionPane.QUESTION_MESSAGE);
        if (!(date == null)) {
          ...
          try {
            ...
            JOptionPane.showMessageDialog(objUpdate.this, "Invalid date format!", "Input Error",
                JOptionPane.ERROR_MESSAGE);
          }
        }
      }
