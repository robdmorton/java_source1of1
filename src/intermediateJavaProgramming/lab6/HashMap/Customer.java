...
public class Customer extends Person {
  ...
  public void parseCustomer() {
    ...
    /*
     * StringTokenizer st = new StringTokenizer(getPersonData(), ","); setFirstName(st.nextToken());
     * setLastName(st.nextToken()); setAccountNumber(st.nextToken());
     */
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof Customer))
      return false;
    return super.equals(o) && ((Customer) o).getAccountNumber().equals(accountNumber);
  }
}
