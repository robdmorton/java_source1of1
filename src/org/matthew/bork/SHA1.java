/*
 * This file contains a modified version of SHA1 class from the URL below. (removed dependence on
 * Sun JCE)
 * 
...
/*
 * @(#)SHA1.java 1.9 2004-04-22 This file was freely contributed to the LimeWire project and is
 * covered by its existing GPL licence, but it may be used individually as a public domain
 * implementation of a published algorithm (see below for references). It was also freely
 * contributed to the Bitzi public domain sources.
 * 
 * @author Philippe Verdy
 */

/*
 * Sun may wish to change the following package name, if integrating this class in the Sun JCE
 * Security Provider for Java 1.5 (code-named Tiger).
 *
 * You can include it in your own Security Provider by inserting this property in your Provider
 * derived class: put("MessageDigest.SHA-1", "com.limegroup.gnutella.SHA1");
 */
 ...
 * change to a message will, with a very high probability, result in a different message digest.
 ...
 * 
 * <p>
 * A "SHS change notice" adds a SHA-224 algorithm for interoperability, which, like SHA-1 and
 * SHA-256, operates on 512-bit blocks and 32-bit words,
 * </p>
 * 
 * <p>
 * <b>References: </b>
 ...
 * Institute of Standards and Technology (NIST), 2002 August 1, and U.S. Department of Commerce,
 * August 26. <br>
...
public final class SHA1 implements Cloneable {
   ...
   * 
   * Can be used to allocate your own output buffer when computing multiple digests.
   * 
   * Overrides the protected abstract method of <code>java.security.MessageDigestSpi</code>.
   * 
   ...
   * 
   * Input length can be any size. May require internal buffering, if input blocks are not multiple
   * of 64 bytes.
   * 
   * Overrides the protected abstract method of java.security.MessageDigestSpi.
   * 
   ...
   * specification.
   * 
   * For faster operations with multiple digests, allocate your own array and use
   ...
   *        solely for consistency in our API's. If the value of this parameter is less than the
   *        actual digest length, the method will throw a DigestException. This parameter is ignored
   *        if its value is greater than or equal to the actual digest length.
   * @return the length of the digest stored in the output buffer.
   */
  ...
  private void computeBlock(final byte[] input, int offset) {
    ...
    /*
     * Use hash schedule function Parity (rounds 20..39): Parity(x,y,z) = x ^ y ^ z, and K20 = ....
     * = K39 = 0x6ed9eba1.
     */
    ...
    /*
     * Use hash schedule function Maj (rounds 40..59): Maj(x,y,z) = (x & y)^(x & z)^(y & z) = ((x &
     * y)|((x | y)& z)), and K40 = .... = K59 = 0x8f1bbcdc.
     */
    ...
    /*
     * Use hash schedule function Parity (rounds 60..79): Parity(x,y,z) = x ^ y ^ z, and K60 = ....
     * = K79 = 0xca62c1d6.
     */
    ...
    /*
     * Terminate the last two rounds of fifth pass, feeding the final digest on the fly.
     */
