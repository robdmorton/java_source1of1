...
public interface Cipher {
  ...
  /**
   * Skip a given number of bytes i.e. advance cipher as if it has been used to encrypt the number
   * of bytes.
   */
   ...
   * @param cipherOff The offset into cipherText to place the encrypted data.
   * @param len The length (in bytes) of data (starting from clearText + clearOff) to encrypt.
   */
   ...
   * @param clearText The buffer where the cleartext will be written.
   * @param clearOff The offset into clearText to place the decrypted data.
   * @param The length (in bytes) of data (starting from cipherText + cipherOff) to decrypt.
   */
