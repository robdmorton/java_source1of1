...
public final class Unsigned
{
  ...
  /**
   * Turns a 32-bit "unsigned" int into the bitwise equivalent 64-bit
   * unsigned value without sign extension. Needed since Java doesn't
   * do unsigned types.
   * 
  ...
  /**
   * Turns a 8-bit "unsigned" byte into the bitwise equivalent 32-bit
   * unsigned value without sign extension. Needed since Java doesn't
   * do unsigned types.
   * 
   * @param value The value to promote.
