    ...
    try {
      ...
      for (int temp = 0; temp < nList.getLength(); temp++) {
        ...
        if (nNode.getNodeType() == Node.ELEMENT_NODE) {
          ...
          System.out
              .println("imsi: " + eElement.getElementsByTagName("imsi").item(0).getTextContent());
          System.out.println(
              "other3: " + eElement.getElementsByTagName("other3").item(0).getTextContent());
        }
      }
      ...
      for (int temp = 0; temp < nList.getLength(); temp++) {
        ...
        if (nNode.getNodeType() == Node.ELEMENT_NODE) {
          ...
          System.out.println(
              "logical: " + eElement.getElementsByTagName("logical").item(0).getTextContent());

          System.out.println("streetaddress: "
              + eElement.getElementsByTagName("streetaddress").item(0).getTextContent());
          System.out
              .println("city: " + eElement.getElementsByTagName("city").item(0).getTextContent());
          if (eElement.getElementsByTagName("stateorprov").item(0) != null) {
            System.out.println("stateorprov: "
                + eElement.getElementsByTagName("stateorprov").item(0).getTextContent());
          }
          System.out.println(
              "code: " + eElement.getElementsByTagName("basicCode").item(0).getTextContent());
