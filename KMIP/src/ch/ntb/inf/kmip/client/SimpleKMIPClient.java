...
public class SimpleKMIPClient {
	...
	public static void main(String[] args) {
		// configure Logger
		DOMConfigurator.configureAndWatch( "logging/config/log4j-1.2.17.xml", 60*1000 );
		logger.info("Hello KMIPClient");
	...
	private static KMIPContainer createKMIPRequest() {
		...
		templateAttributes.add(new Name("rmorton-aes-key-5"));
...
//		templateAttributes.add(new CryptographicLength(128));
		templateAttributes.add(new CryptographicLength(256));
