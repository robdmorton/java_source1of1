...
- Help -> install new software -> all available sites -> Programming Languages -> C/C++
- Help -> install new software -> all available sites -> releng tools
- Help -> install new software -> all available sites -> ??? Kotlin
