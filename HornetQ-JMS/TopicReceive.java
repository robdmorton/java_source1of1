...
public final static String TOPIC="/TestT";
...
tcon = tconFactory.createTopicConnection("nazia","nazia123!");
...
//tsubscriber = tsession.createDurableSubscriber(topic, "subscriber1");
...
env.put("java.naming.security.principal","nazia");
env.put("java.naming.security.credentials","nazia123!");
